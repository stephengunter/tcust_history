...
namespace TzuChiBackend.Controllers
{
    ...
    {
        //語言教育中心
        IEducationCenterManagement gEducationCenterManagement = new EducationCenterManagementImpl();

        // GET: Backend/EducationCenter
        public ActionResult List()
        {
            ...
            //頁數
            var models = gEducationCenterManagement.GetAll(pagenation);
        ...
        {
            EducationCenterModel result = null;
            ...
            else
            {
                ...
                result = gEducationCenterManagement.GetByContentId(contentID);
            }
        ...
        public ActionResult Page(EducationCenterModel model, string command)
        {
            ...
            {
                if (gEducationCenterManagement.Add(model))
            ...
            {
                if (gEducationCenterManagement.Update(model))
        ...
        {
            Boolean result = gEducationCenterManagement.Delete(contentId);
            return RedirectToAction("List");
        }
    }
}