...
namespace TzuChiBackend.Security
{
    public class CustomMembershipProvider : MembershipProvider
    {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            List<AdminModel> adminList = adminManagement.GetAdmin();

            var user = (from u in adminList
                        where String.Compare(u.Account, username, StringComparison.OrdinalIgnoreCase) == 0
