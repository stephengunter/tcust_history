namespace TzuChiClassLibrary
{
    ...
    public partial class Content
    {
        ...
        public Content()
        {
            FileUplaod = new HashSet<FileUplaod>();
            ImageShow = new HashSet<ImageShow>();
        }
        ...
        public virtual ICollection<FileUplaod> FileUplaod { get; set; }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<ImageShow> ImageShow { get; set; }
